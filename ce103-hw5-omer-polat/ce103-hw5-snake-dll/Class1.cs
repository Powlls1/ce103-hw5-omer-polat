...
namespace ce103_hw5_snake_dll
{
    public class Class1
    {
        ...
        public ConsoleKey waitForAnyKey()
        {
            ...
            pros = Console.ReadKey(false).Key;
        ...
        public ConsoleKey checkKeysPressed(ConsoleKey destination)
        {
            ConsoleKey pros;
            ...
            if (Console.KeyAvailable == true) //If a key has been pressed
            {
                ...
                if (destination != pros)
                {
                    if (pros == DOWN_ARROW && destination != UP_ARROW)
                    {
                        destination = pros;
                    }
                    else if (pros == UP_ARROW && destination != DOWN_ARROW)
                    {
                        destination = pros;
                    }
                    else if (pros == LEFT_ARROW && destination != RIGHT_ARROW)
                    {
                        destination = pros;
                    }
                    else if (pros == RIGHT_ARROW && destination != LEFT_ARROW)
                    {
                        destination = pros;
                    }
                    else if (pros == EXIT_BUTTON || pros == PAUSE_BUTTON)
                    {
                        pauseMenu();
                    }
                }
        ...
        **/
        ...
        public void refreshInfoBar(int score, int speed)
        {
            ...
            Console.Write("Coder: Ömer Polat");
        ...
        public void startGame(int[,] snakeXY, int[] foodXY, int consoleWidth, int consoleHeight, int snakeLength, ConsoleKey destination, int score, int speed)
        {
            bool gameOver = false;
            ConsoleKey oldDestination = ConsoleKey.NoName;
            ...
            do
            {
                if (canChangeDirection)
                {
                    ...
                    destination = checkKeysPressed(destination);
                }

                if (oldDestination != destination)//Temp fix to prevent the snake from colliding with itself
                ...
                if (true) //haha, it moves according to how fast the computer running it is...
                {
                    ...
                    move(snakeXY, snakeLength, destination);
        ...
        public void exitYN()
        {
            ...
            do
            {
                pros = (char)waitForAnyKey();
                pros = char.ToLower(pros);
            } while (!(pros == 'y' || pros == 'n'));
